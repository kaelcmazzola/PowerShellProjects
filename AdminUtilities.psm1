...
Param(
     ...
     [string]$ReportFilename
         ...
         $frag2 = Get-Service -ComputerName $ComputerName | Select-Object Status,Name,DisplayName | Sort-Object Status,Name |
                          ConvertTo-HTML -Fragment -As Table -PreContent "<h2>Services</h2>" |
                          Out-String
 
         <# $frag3 = Get-ADUser -Filter * | select Name,Department,Email,AccountExpirationDate |
         ...
         $style = Get-StyleSheet
                  ...
                  -Head $style `
                  -Body "<h1>Report for $ComputerName</h1>",$frag1,$frag2 |
